package com.reesecake.reesemod.armor;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    REESE(ReeseMod.MOD_ID + ":reese",20, new int[] { 2, 5, 6, 2 }, 18,
            SoundEvents.BLOCK_NOTE_BLOCK_GUITAR, 0.0F, () -> { return Ingredient.fromItems(RegistryHandler.REESE_ITEM.get());},
            0);
